...
function createCirclePointProvider(x, y, radius, initialAngle, speed) {
	// const speed = Math.abs(anim.speed) ?? 1;
...
function createLinePointProvider(step, x1, y1, x2, y2, speed) {
	const slope = (y2 - y1) / (x2 - x1);
	const offset = y1 - slope * x1;
	return (deltaTime, entity) => {
